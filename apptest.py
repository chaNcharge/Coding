...
class MainWindow(QMainWindow):
    ...
    def playHandler(self):
        self.userAction = 1
        self.statusBar().showMessage('Playing at Volume {0}'.format(self.player.volume()))
    ...
    def openFile(self):
        fileChoosen = QFileDialog.getOpenFileUrl(self,'Open Music File', expanduser('~'),'Audio (*.mp3 *.ogg *.wav *.m4a)')
        if fileChoosen != None:
